...
def baiduOCR(picfile):
    ...
    APP_ID = '19601119'  # 刚才获取的ID，下同
    API_KEY = '8eOYSbWc969FmcWn6fn32Sqt'
    SECRECT_KEY = 'G1dig8o5rGhAnL3WqS8G6OTRiBVhMzfw'
...
pic_path = r'C:\Users\修羽\PycharmProjects\个人兴趣\表情包/'         # 目标路径，需要改成你自己需要改名称的路径，最后最后的/不要漏了
